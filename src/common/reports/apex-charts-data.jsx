...
export const Currentlysale = {
  series: [{
    name: 'Ventas Totales',
    data: [10400.80, 9209.80, 9802.20, 10730.90, 10181.20, 9820.00, 10600.20, 13050.00, 12201.99, 12022.12, 10210.29, 9280.12, 13299.80]
  }, {
    name: 'Venta Local',
    data: [8920.20, 7889.80, 8020.20, 9730.90, 9181.20, 7820.00, 8600.20, 10050.00, 9201.99, 9022.12, 8210.29, 8280.12, 9299.80]

  }
    , {
    name: 'Venta Delivery',
    data: [1480.80, 1320, 950, 990, 720, 1120, 1600.20, 1350.00, 1221.99, 1202.12, 1021.29, 928.12, 1329.80]
  ...
  options: {
    ...
    markers: {
      strokeWidth: 3,
      colors: "#ffffff",
      strokeColors: [primary, secondary, extra],
      hover: {
        size: 6,
      }
    },
